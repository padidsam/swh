...
<!--        <span class="label pull-right label-danger">Danger</span> -->
        <a type="button" href="index.php?r=admin/newsset" class="btn-u btn-u-xs rounded btn-u-red pull-right">เพิ่ม</a>
                ...
                <tbody>
                    ...
                    foreach ($list as $ds) {
                        ...
                        <tr class="">
                            ...
                            <td> <?php echo $ds['NEWS_ID'] ?></td>
                            <td> <?php echo $ds['NEWS_HEAD'] ?></td>
                            <td> <?php echo $ds['NEWS_TYPE_NAME'] ?></td>
                            <td align="right">
                                <a href="index.php?r=admin/newsset&id=<?= $ds['NEWS_ID'] ?>"><img src="images/edit.png"></a>
                                <a onClick="javascript:return confirm('ต้องการลบ?')" href="index.php?r=admin/newsdel&id=<?= $ds['NEWS_ID'] ?>"><img src="images/del.png"></a>
                            </td>
                        </tr>
                        <?php
                        $i++;
