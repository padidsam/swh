<div class="container content">
  ...
  <div class="panel panel-default">
    <div class="panel-heading" >
      ...
      <h5 class="panel-title">หน้าหลัก ดาวน์โหลด</h5>
    </div>
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <h3 class="panel-title"><font color="red">ดาวน์โหลด</font></h3>
    </div>
          ...
          <tbody>
            ...
            foreach ($list as $ds) {
              ...
              <tr class="">
                ...
                <td align="right">
                  <a href="index.php?r=admin/downloadset&id=<?= $ds['ID'] ?>"><img src="images/edit.png"></a>
                  <a onClick="javascript:return confirm('ต้องการลบ?')" href="index.php?r=admin/downloaddel&id=<?= $ds['ID'] ?>"><img src="images/del.png"></a>
                </td>
              </tr>
              <?php
              $i++;
